...
The namespace is the your (team's) 'private' part of the cluster. The name of
...
As you learn more about the behaviour of your applications on Kubernetes you
can change the limits on your namespace.
